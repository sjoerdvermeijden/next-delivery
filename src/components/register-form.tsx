...
function RegisterForm({ }) {
    ...
    return (
        <>
            ...
            <form action="" className='flex flex-col mb-6' onSubmit={handleSubmit(onSubmit)}>
                <label htmlFor="name" className='mb-1.5 text-xs font-bold'>Naam</label>
                <input className='mb-3 border p-2 rounded-xl placeholder:text-sm' placeholder="Naam" type="text" id="name" {...register("name", { required: true })} />
                <label htmlFor="email" className='mb-1.5 text-xs font-bold'>E-mailadres</label>
                <input className='mb-3 border p-2 rounded-xl placeholder:text-sm' placeholder="Email" type="email" id="email" {...register("email", {
                    required: "required",
                    pattern: {
                        value: /\S+@\S+\.\S+/,
                ...
                <input className='mb-4 border p-2 rounded-xl placeholder:text-sm' placeholder="Wachtwoord" type="password" id="wachtwoord" {...register("password", { required: true })}  />
